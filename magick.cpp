...
void test_vector_unit_3d_1d()
{
	...
	force a (50_N,direction::name::left);
	force b (20_N,direction::name::right);
	cout << "a: " << a << endl;
	cout << "b: " << b << endl;
	...
	force c (10_N,direction::name::left);
	cout << "c: " << c << endl;
	c += 25;
	cout << "c += 25: " << c << endl;
	force d (20_N,direction::name::left);
	cout << "d: " << d << endl;
	d -= 5;
	cout << "d -= 5: " << d << endl;
	force e (15_N,direction::name::left);
	cout << "e: " << e << endl;
	e *= 10;
	cout << "e *= 10: " << e << endl;
	force f (30_N,direction::name::left);
	cout << "f: " << f << endl;
	f /= 5;
	cout << "f /= 5: " << f << endl;
	force g (5_N,direction::name::left);
	cout << "g: " << g << endl;
	g ^= 2;
	cout << "g ^= 2: " << g << endl;
}/*
