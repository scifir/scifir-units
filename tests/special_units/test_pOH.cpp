...
TEST_CASE("pOH class") {
	SECTION("Constructors of pOH class") {
        ...
        pOH e = pOH("3");
        CHECK (bool(e.get_value() == 3.0f));
        scalar_unit f2 = 30_g;
        pOH f = pOH(f2 / 10_g);
        CHECK (bool(f.get_value() == 3.0f));
        scalar_unit g2 = 30_g;
        pOH g = pOH(g2);
        CHECK (bool(g.get_value() == 0.0f));
    }
    ...
    {
        pOH a(4.5f);
        CHECK (bool(float(a) == 4.5f));
        pOH b(3.2f);
        CHECK (bool(b.get_value() == 3.2f));
    }
    ...
    SECTION("Numeric operators of pOH class")
    {
        ...
        pOH e(5.0f);
        e += 1.0f;
        CHECK (bool(e.get_value() == 6.0f));
        pOH f(6.0f);
        f -= 2.0f;
        CHECK (bool(f.get_value() == 4.0f));
        pOH g(6.0f);
        g++;
        CHECK (bool(g.get_value() == 7.0f));
        pOH h(8.0f);
        ++h;
        CHECK (bool(h.get_value() == 9.0f));
        pOH i(6.0f);
        i--;
        CHECK (bool(i.get_value() == 5.0f));
        pOH j(8.0f);
        --j;
        CHECK (bool(j.get_value() == 7.0f));
    }
    ...
    {
        pOH a(4.0f);
        CHECK (bool(a.is_acidic() == false));
        CHECK (bool(a.is_basic() == true));
        CHECK (bool(a.is_neutral() == false));
        pOH b(11.0f);
        CHECK (bool(b.is_acidic() == true));
        CHECK (bool(b.is_basic() == false));
        CHECK (bool(b.is_neutral() == false));
        pOH c(7.0f);
        CHECK (bool(c.is_neutral() == true));
    }

    SECTION("Display of pOH")
    {
        pOH a(6.5f);
        CHECK (bool(a.display() == "6.5"));
        CHECK (bool(to_string(a) == "6.5"));
    }
    ...
    SECTION("Normalize value of pOH")
    {
        ...
        CHECK (bool(a.get_value() == 0.0f));
        pOH b(0.5f);
        CHECK (bool(b.get_value() == 0.0f));
    }

    SECTION("Comparison operators of pOH class with pOH classes")
    {
        CHECK (bool((pOH(3.0f) == pOH(3.0f)) == true));
        CHECK (bool((pOH(3.0f) == pOH(2.0f)) == false));
        CHECK (bool((pOH(3.0f) != pOH(2.0f)) == true));
        CHECK (bool((pOH(3.0f) > pOH(2.0f)) == true));
        CHECK (bool((pOH(2.0f) > pOH(3.0f)) == false));
        CHECK (bool((pOH(3.0f) >= pOH(2.0f)) == true));
        CHECK (bool((pOH(3.0f) < pOH(4.0f)) == true));
        CHECK (bool((pOH(4.0f) < pOH(3.0f)) == false));
        CHECK (bool((pOH(3.0f) <= pOH(4.0f)) == true));
    }

    SECTION("Comparison operators of pOH class with numeric types")
    {
        CHECK (bool((pOH(3.0f) == 3.0f) == true));
        CHECK (bool((pOH(3.0f) == 2.0f) == false));
        CHECK (bool((pOH(3.0f) != 2.0f) == true));
        CHECK (bool((3.0f == pOH(3.0f)) == true));
        CHECK (bool((2.0f == pOH(3.0f)) == false));
        CHECK (bool((2.0f != pOH(3.0f)) == true));
        CHECK (bool((pOH(3.0f) > 2.0f) == true));
        CHECK (bool((pOH(3.0f) >= 2.0f) == true));
        CHECK (bool((pOH(3.0f) < 4.0f) == true));
        CHECK (bool((pOH(3.0f) <= 4.0f) == true));
        CHECK (bool((2.0f < pOH(3.0f)) == true));
        CHECK (bool((2.0f <= pOH(3.0f)) == true));
        CHECK (bool((4.0f > pOH(3.0f)) == true));
        CHECK (bool((4.0f >= pOH(3.0f)) == true));
    }
    ...
    SECTION("String operators with pOH class")
    {
        ...
        a += pOH(4.0f);
        CHECK (bool(a == "pOH: 4"));
        CHECK (bool(("pOH: " + pOH(5.0f)) == "pOH: 5"));
        CHECK (bool((pOH(5.0f) + " pOH") == "5 pOH"));
    }
