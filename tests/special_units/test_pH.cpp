...
TEST_CASE("pH class") {
    ...
    {
        pH a(4.0f);
        CHECK (bool(a.is_acidic() == true));
        CHECK (bool(a.is_basic() == false));
        CHECK (bool(a.is_neutral() == false));
        pH b(11.0f);
        CHECK (bool(b.is_acidic() == false));
        CHECK (bool(b.is_basic() == true));
    ...
    {
        CHECK (bool((pH(3.0f) == pH(3.0f)) == true));
        CHECK (bool((pH(3.0f) == pH(2.0f)) == false));
        CHECK (bool((pH(3.0f) != pH(2.0f)) == true));
        CHECK (bool((pH(3.0f) > pH(2.0f)) == true));
        CHECK (bool((pH(2.0f) > pH(3.0f)) == false));
        CHECK (bool((pH(3.0f) >= pH(2.0f)) == true));
        CHECK (bool((pH(3.0f) < pH(4.0f)) == true));
        CHECK (bool((pH(4.0f) < pH(3.0f)) == false));
        CHECK (bool((pH(3.0f) <= pH(4.0f)) == true));
    }

    SECTION("Comparison operators of pH class with numeric types")
    {
        CHECK (bool((pH(3.0f) == 3.0f) == true));
        CHECK (bool((pH(3.0f) == 2.0f) == false));
        CHECK (bool((pH(3.0f) != 2.0f) == true));
        CHECK (bool((3.0f == pH(3.0f)) == true));
        CHECK (bool((2.0f == pH(3.0f)) == false));
        CHECK (bool((2.0f != pH(3.0f)) == true));
        CHECK (bool((pH(3.0f) > 2.0f) == true));
        CHECK (bool((pH(3.0f) >= 2.0f) == true));
        CHECK (bool((pH(3.0f) < 4.0f) == true));
        CHECK (bool((pH(3.0f) <= 4.0f) == true));
        CHECK (bool((2.0f < pH(3.0f)) == true));
        CHECK (bool((2.0f <= pH(3.0f)) == true));
        CHECK (bool((4.0f > pH(3.0f)) == true));
        CHECK (bool((4.0f >= pH(3.0f)) == true));
    }
    ...
    SECTION("String operators with pH class")
    {
        ...
        a += pH(4.0f);
        CHECK (bool(a == "pH: 4"));
        CHECK (bool(("pH: " + pH(5.0f)) == "pH: 5"));
        CHECK (bool((pH(5.0f) + " pH") == "5 pH"));
    }
