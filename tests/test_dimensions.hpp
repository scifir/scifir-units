#ifndef SCIFIR_UNITS_TESTS_TEST_DIMENSIONS_HPP_INCLUDED
#define SCIFIR_UNITS_TESTS_TEST_DIMENSIONS_HPP_INCLUDED
...
#endif // SCIFIR_UNITS_TESTS_TEST_DIMENSIONS_HPP_INCLUDED
