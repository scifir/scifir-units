...
TEST_CASE("class coordinates_ndr<T> and coordinates_ndr<float>")
{
	...
	SECTION("Assignments of coordinates_ndr<> class")
	{
		...
		coordinates_ndr<> a2(5_m,5_m,1_m,angle(15.0f),angle(25.0f));
		a = a2;
		CHECK (bool(to_string(a) == "(5 m,5 m,1 m;15\u00B0,25\u00B0)"));
		coordinates_ndr<> b;
		coordinates_ndr<> b2(5_m,5_m,1_m,angle(15.0f),angle(25.0f));
		b = std::move(b2);
		CHECK (bool(to_string(b) == "(5 m,5 m,1 m;15\u00B0,25\u00B0)"));
	...
	SECTION("nd functions of coordinates_ndr<> class")
	{
		...
		CHECK (bool(a.is_nd(3) == true));
		CHECK (bool(a.get_nd() == 3));
		a.change_nd({2_m,3_m},vector<angle>{angle(10.0f)});
		CHECK (bool(to_string(a) == "(2 m,3 m;10\u00B0)"));
		a.change_nd({2_m,3_m,4_m,5_m},vector<float>{10.0f,20.0f,30.0f});
		CHECK (bool(to_string(a) == "(2 m,3 m,4 m,5 m;10\u00B0,20\u00B0,30\u00B0)"));
	}
	...
	SECTION("Value and angle functions of coordinates_ndr<> class")
	{
		...
		CHECK (bool(a.get_angles().size() == 2));
	...
	SECTION("Value and angle functions of coordinates_ndr<float> class")
	{
		coordinates_ndr<float> a(7.0f,4.0f,2.0f,angle(15.0f),angle(25.0f));
		CHECK (bool(a.get_values().size() == 3));
		CHECK (bool(a.get_value(0) == 7.0f));
		CHECK (bool(a.get_value(1) == 4.0f));
		CHECK (bool(a.get_value(2) == 2.0f));
		CHECK (bool(a.get_value(3) == 0.0f));
		a.set_values({2.0f,5.0f,7.0f});
		CHECK (bool(a.get_value(0) == 2.0f));
		CHECK (bool(a.get_value(1) == 5.0f));
		CHECK (bool(a.get_value(2) == 7.0f));
		CHECK (bool(a.get_angles().size() == 2));
		CHECK (bool(a.get_angle(0) == "15\u00B0"));
		CHECK (bool(a.get_angle(1) == "25\u00B0"));
		a.set_angles({angle(45.0f),angle(63.0f)});
		...
		CHECK (bool(b.get_values().size() == 3));
		CHECK (bool(b.get_value(0) == 7.0f));
		CHECK (bool(b.get_value(1) == 4.0f));
		CHECK (bool(b.get_value(2) == 2.0f));
		CHECK (bool(b.get_value(3) == 0.0f));
		CHECK (bool(b.get_angles().size() == 2));
		CHECK (bool(b.get_angle(0) == "15\u00B0"));
		CHECK (bool(b.get_angle(1) == "25\u00B0"));
		CHECK (bool(b.get_angle(2) == "0\u00B0"));
	...
	{
		coordinates_ndr<> a(7_m,4_m,2_m,angle(15.0f),angle(25.0f));
		CHECK (bool(a.get_p().display() == "8.06 m"));
		CHECK (bool(a.get_spherical_theta().display() == "29.74\u00B0"));
		CHECK (bool(a.get_r().display() == "8.3 m"));
		CHECK (bool(a.get_spherical_phi().display() == "76.06\u00B0"));
		...
		/*CHECK (bool(c.get_latitude() == angle(0.0f)));
		CHECK (bool(c.get_longitude() == angle(29.74f)));
		CHECK (bool(c.get_altitude() == "0 m"));*/
	}
	...
	SECTION("Values of different coordinates systems of coordinates_ndr<float> class")
	{
		...
		CHECK (bool(std::fabs(c.get_p() - 8.06f) < 0.01f));
		CHECK (bool(c.get_spherical_theta().display() == "29.74\u00B0"));
		CHECK (bool(std::fabs(c.get_r() - 8.3f) < 0.01f));
		CHECK (bool(c.get_spherical_phi().display() == "76.06\u00B0"));
		coordinates_ndr<float> b(7.0f);
		CHECK (bool(b.get_p() == 0.0f));
		CHECK (bool(b.get_spherical_theta() == angle()));
		CHECK (bool(b.get_r() == 0.0f));
		CHECK (bool(b.get_spherical_phi() == angle()));
		/*CHECK (bool(c.get_latitude() == angle(0.0f)));
		CHECK (bool(c.get_longitude() == angle(29.74f)));
		CHECK (bool(c.get_altitude() == "0 m"));*/
	...
	SECTION("point_to() function of coordinates_ndr<> class for the 2d case")
	{
		...
		a.point_to(direction::LEFT);
		CHECK (bool(a.get_angle(0).get_value() == 180.0f));
		a.point_to(direction::RIGHT);
		CHECK (bool(a.get_angle(0).get_value() == 0.0f));
		a.point_to(direction::TOP);
		CHECK (bool(a.get_angle(0).get_value() == 90.0f));
		a.point_to(direction::BOTTOM);
		CHECK (bool(a.get_angle(0).get_value() == 270.0f));
		a.point_to(direction::LEFT_TOP);
		CHECK (bool(a.get_angle(0).get_value() == 135.0f));
		a.point_to(direction::RIGHT_TOP);
		CHECK (bool(a.get_angle(0).get_value() == 45.0f));
		a.point_to(direction::RIGHT_BOTTOM);
		CHECK (bool(a.get_angle(0).get_value() == 315.0f));
		a.point_to(direction::LEFT_BOTTOM);
		CHECK (bool(a.get_angle(0).get_value() == 225.0f));
	}
	...
	SECTION("point_to() function of coordinates_ndr<> class for the 3d case")
	{
		...
		a.point_to(direction::LEFT);
		CHECK (bool(a.get_angle(0).get_value() == 270.0f));
		CHECK (bool(a.get_angle(1).get_value() == 90.0f));
		a.point_to(direction::RIGHT);
		CHECK (bool(a.get_angle(0).get_value() == 90.0f));
		CHECK (bool(a.get_angle(1).get_value() == 90.0f));
		a.point_to(direction::TOP);
		CHECK (bool(a.get_angle(0).get_value() == 0.0f));
		CHECK (bool(a.get_angle(1).get_value() == 0.0f));
		a.point_to(direction::BOTTOM);
		CHECK (bool(a.get_angle(0).get_value() == 0.0f));
		CHECK (bool(a.get_angle(1).get_value() == 180.0f));
		a.point_to(direction::LEFT_TOP);
		CHECK (bool(a.get_angle(0).get_value() == 270.0f));
		CHECK (bool(a.get_angle(1).get_value() == 45.0f));
		a.point_to(direction::RIGHT_TOP);
		CHECK (bool(a.get_angle(0).get_value() == 90.0f));
		CHECK (bool(a.get_angle(1).get_value() == 45.0f));
		a.point_to(direction::RIGHT_BOTTOM);
		CHECK (bool(a.get_angle(0).get_value() == 90.0f));
		CHECK (bool(a.get_angle(1).get_value() == 135.0f));
		a.point_to(direction::LEFT_BOTTOM);
		CHECK (bool(a.get_angle(0).get_value() == 270.0f));
		CHECK (bool(a.get_angle(1).get_value() == 135.0f));
	...
	SECTION("set_position(), rotate() and move() of coordinates_ndr<float> class")
	{
		...
		CHECK (bool(to_string(a) == "(4.33,2.5,1;15\u00B0,25\u00B0)"));
		a.set_position(5.0f,angle(30.0f),angle(45.0f));
		CHECK (bool(to_string(a) == "(3.06,1.76,3.53;15\u00B0,25\u00B0)"));
		/*a.set_position(angle(30.0f),angle(45.0f),100_m);
		cout << "geographical coordinates: " << to_string(a) << endl;
		CHECK (bool(to_string(a) == "(61.23 m,61.23 m,50 m)"));*/
		coordinates_ndr<float> b2(20.0f,angle(60.0f),angle(20.0f));
		b2.rotate_in_2d(angle(15.0f));
		CHECK (bool(to_string(b2) == "(5.17,19.31;20\u00B0)"));
		coordinates_ndr<float> b(5.0f,3.0f,1.0f,angle(15.0f),angle(25.0f));
		b.rotate_in_3d(1,angle(45.0f));
		CHECK (bool(to_string(b) == "(5,1.41,2.82;15\u00B0,25\u00B0)"));
		coordinates_ndr<float> c(7.0f,4.0f,2.0f,angle(15.0f),angle(25.0f));
		c.rotate_in_3d(2,angle(45.0f));
		CHECK (bool(to_string(c) == "(3.53,4,6.36;15\u00B0,25\u00B0)"));
		coordinates_ndr<float> d(4.0f,2.0f,3.0f,angle(15.0f),angle(25.0f));
		d.rotate_in_3d(3,angle(45.0f));
		CHECK (bool(to_string(d) == "(1.41,4.24,3;15\u00B0,25\u00B0)"));
		coordinates_ndr<float> e(1.0f,2.0f,3.0f,angle(15.0f),angle(25.0f));
		displacement_3d e2(3_m,angle(0.0f),angle(0.0f));
		e.move(e2);
		CHECK (bool(to_string(e) == "(1,2,6;15\u00B0,25\u00B0)"));
		coordinates_ndr<float> f(1.0f,2.0f,3.0f,angle(15.0f),angle(25.0f));
		f.move(2.0f,1.0f,3.0f);
		CHECK (bool(to_string(f) == "(3,3,6;15\u00B0,25\u00B0)"));
		coordinates_ndr<float> g(1.0f,2.0f,3.0f,angle(15.0f),angle(25.0f));
		g.move(2.0f,angle(45.0f),3.0f);
		CHECK (bool(to_string(g) == "(2.41,3.41,6;15\u00B0,25\u00B0)"));
		coordinates_ndr<float> h(1.0f,2.0f,3.0f,angle(15.0f),angle(25.0f));
		h.move(2.0f,angle(0.0f),angle(45.0f));
		CHECK (bool(to_string(h) == "(2.41,2,4.41;15\u00B0,25\u00B0)"));
	}

	SECTION("distance_to_origin() of coordinates_ndr<> class")
	{
		coordinates_ndr<> a(2_m,3_m,5_m,angle(15.0f),angle(25.0f));
		CHECK (bool(a.distance_to_origin().display() == "6.16 m"));
	}

	SECTION("distance_to_origin() of coordinates_ndr<float> class")
	{
		coordinates_ndr<float> a(2.0f,3.0f,5.0f,angle(15.0f),angle(25.0f));
		CHECK (bool(std::fabs(a.distance_to_origin() - 6.16f) < 0.01f));
	}

	SECTION("Display of coordinates_ndr<> class")
	{
		coordinates_ndr<> a(2_m,3_m,5_m,angle(15.0f),angle(25.0f));
		CHECK (bool(a.display_cartesian_2d() == "[no-2d]"));
		CHECK (bool(a.display_polar() == "[no-2d]"));
		CHECK (bool(a.display_cartesian_3d() == "(2 m,3 m,5 m;15\u00B0,25\u00B0)"));
		CHECK (bool(a.display_cylindrical() == "(3.6 m,56.3\u00B0,5 m;15\u00B0,25\u00B0)"));
		CHECK (bool(a.display_spherical() == "(6.16 m,56.3\u00B0,35.79\u00B0;15\u00B0,25\u00B0)"));
		coordinates_ndr<> b(2_m,angle(40.0f),angle(15.0f));
		CHECK (bool(b.display_cartesian_2d() == "(1.53 m,1.28 m;15°)"));
		CHECK (bool(b.display_polar() == "(2 m,40°;15°)"));
		CHECK (bool(b.display_cartesian_3d() == "[no-3d]"));
		CHECK (bool(b.display_cylindrical() == "[no-3d]"));
		CHECK (bool(b.display_spherical() == "[no-3d]"));
		//CHECK (bool(b.display_geographical() == "[no-3d]"));
		/*coordinates_ndr<> b(2_m,3_m,10000_km);
		cout << "b display geographical: " << b.display_geographical() << endl;
		CHECK (bool(b.display_geographical() == ""));*/
	}
	...
	SECTION("Display of coordinates_ndr<float> class")
	{
		...
		CHECK (bool(a.display_cartesian_2d() == "[no-2d]"));
		CHECK (bool(a.display_polar() == "[no-2d]"));
		CHECK (bool(a.display_cartesian_3d() == "(2,3,5;15\u00B0,25\u00B0)"));
		CHECK (bool(a.display_cylindrical() == "(3.6,56.3\u00B0,5;15\u00B0,25\u00B0)"));
		CHECK (bool(a.display_spherical() == "(6.16,56.3\u00B0,35.79\u00B0;15\u00B0,25\u00B0)"));
		coordinates_ndr<float> b(2.0f,angle(40.0f),angle(15.0f));
		CHECK (bool(b.display_cartesian_2d() == "(1.53,1.28;15°)"));
		CHECK (bool(b.display_polar() == "(2,40°;15°)"));
		CHECK (bool(b.display_cartesian_3d() == "[no-3d]"));
		CHECK (bool(b.display_cylindrical() == "[no-3d]"));
		CHECK (bool(b.display_spherical() == "[no-3d]"));
		/*coordinates_ndr<> b(2_m,3_m,10000_km);
	...
	{
		coordinates_ndr<> a(2_m,3_m,5_m,angle(15.0f),angle(25.0f));
		CHECK (bool(to_string(a) == "(2 m,3 m,5 m;15\u00B0,25\u00B0)"));
	}

	SECTION("to_string() of coordinates_ndr<float> class")
	{
		coordinates_ndr<float> a(2.0f,3.0f,5.0f,angle(15.0f),angle(25.0f));
		CHECK (bool(to_string(a) == "(2,3,5;15\u00B0,25\u00B0)"));
	}
	...
	SECTION("distance() of coordinates_ndr<> class")
	{
		...
		CHECK (bool(distance(a,b).display() == "1.41 m"));
		coordinates_ndr<> b2(6_m,2_m,angle(20.0f));
		CHECK (bool(distance(a,b2) == length()));
		point_nd<> c(7_m,3_m,1_m);
		CHECK (bool(distance(a,c).display() == "0 m"));
		CHECK (bool(distance(c,a).display() == "0 m"));
		CHECK (bool(distance(b,c).display() == "1.41 m"));
		CHECK (bool(distance(c,b).display() == "1.41 m"));
		point_nd<> c2(7_m,3_m);
		CHECK (bool(distance(a,c2) == length()));
		CHECK (bool(distance(c2,a) == length()));
		coordinates_nd<> d(7_m,3_m,1_m);
		CHECK (bool(distance(a,d).display() == "0 m"));
		CHECK (bool(distance(d,a).display() == "0 m"));
		CHECK (bool(distance(b,d).display() == "1.41 m"));
		CHECK (bool(distance(d,b).display() == "1.41 m"));
	...
	SECTION("distance() of coordinates_ndr<float> class")
	{
		...
		CHECK (bool(std::fabs(distance(a,b) - 1.41f) < 0.01f));
		coordinates_ndr<float> b2(6.0f,2.0f,angle(20.0f));
		CHECK (bool(distance(a,b2) == 0.0f));
		point_nd<float> c(7.0f,3.0f,1.0f);
		CHECK (bool(std::fabs(distance(a,c) - 0.0f) < 0.01f));
		CHECK (bool(std::fabs(distance(c,a) - 0.0f) < 0.01f));
		CHECK (bool(std::fabs(distance(b,c) - 1.41f) < 0.01f));
		CHECK (bool(std::fabs(distance(c,b) - 1.41f) < 0.01f));
		point_nd<float> c2(7.0f,3.0f);
		CHECK (bool(distance(a,c2) == 0.0f));
		CHECK (bool(distance(c2,a) == 0.0f));
		coordinates_nd<float> d(7.0f,3.0f,1.0f);
		CHECK (bool(distance(a,d) == 0.0f));
		CHECK (bool(distance(d,a) == 0.0f));
		CHECK (bool(std::fabs(distance(b,d) - 1.41f) < 0.01f));
		CHECK (bool(std::fabs(distance(d,b) - 1.41f) < 0.01f));
		coordinates_nd<float> d2(7.0f,3.0f);
		CHECK (bool(distance(a,d2) == 0.0f));
		CHECK (bool(distance(d2,a) == 0.0f));
	}
	...
	SECTION("Relational operators of coordinates_ndr<> class")
	{
		...
		CHECK(bool((a == c2) == false));
		CHECK(bool(a != c));
		CHECK(bool((c == c3) == false));
		point_nd<> d(7_m,3_m,1_m);
		point_nd<> e(5_m,1_m,1_m);
		point_nd<> e2(5_m,1_m);
		CHECK(bool(a == d));
		CHECK(bool(a != e));
		CHECK(bool(a == e2) == false);
		CHECK(bool(e2 == a) == false);
		CHECK(bool(d == a));
		CHECK(bool(e != a));
		...
		CHECK(bool(a == f));
		CHECK(bool(a != g));
		CHECK(bool(a == g2) == false);
		CHECK(bool(g2 == a) == false);
		CHECK(bool(f == a));
		CHECK(bool(g != a));
	}
	...
	SECTION("String operators of coordinates_ndr<> class")
	{
		...
		string b = "x: ";
		b += a;
		CHECK(bool(b == "x: (7 m,4 m,2 m;15\u00B0,25\u00B0)"));
		CHECK(bool(("x: " + a) == "x: (7 m,4 m,2 m;15\u00B0,25\u00B0)"));
		CHECK(bool("x: (7 m,4 m,2 m;15\u00B0,25\u00B0)" == ("x: " + a)));
	}
	...
	SECTION("String operators of coordinates_ndr<float> class")
	{
		...
		string b = "x: ";
		b += a;
		CHECK(bool(b == "x: (7,4,2;15\u00B0,25\u00B0)"));
		CHECK(bool(("x: " + a) == "x: (7,4,2;15\u00B0,25\u00B0)"));
		CHECK(bool("x: (7,4,2;15\u00B0,25\u00B0)" == ("x: " + a)));
	}
	...
	SECTION("Stream operators of coordinates_ndr<> class")
	{
		...
		ostringstream out;
		out << a;
		CHECK(bool(out.str() == "(2 m,3 m,2 m;15\u00B0,25\u00B0)"));
		istringstream iss("(1 m,2 m,1 m;15\u00B0,25\u00B0)");
		coordinates_ndr<> b;
		iss >> b;
		CHECK(bool(to_string(b) == "(1 m,2 m,1 m;15\u00B0,25\u00B0)"));
	}
	...
	SECTION("Stream operators of coordinates_ndr<float> class")
	{
		...
		ostringstream out;
		out << a;
		CHECK(bool(out.str() == "(2,3,2;15\u00B0,25\u00B0)"));
		istringstream iss("(1,2,1;15\u00B0,25\u00B0)");
		coordinates_ndr<float> b;
		iss >> b;
		CHECK(bool(to_string(b) == "(1,2,1;15\u00B0,25\u00B0)"));
	}
}
