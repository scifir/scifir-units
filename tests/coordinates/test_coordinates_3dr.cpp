...
TEST_CASE("class coordinates_3dr<T> and coordinates_3dr<float>")
{
	...
	SECTION("Assignments of coordinates_3dr<> class")
	{
		...
		a = a2;
		CHECK (bool(to_string(a) == "(5 m,5 m,1 m;20\u00B0,30\u00B0)"));
		coordinates_3dr<> b;
		coordinates_3dr<> b2(5_m,5_m,1_m,angle(20.0f),angle(30.0f));
		b = std::move(b2);
		CHECK (bool(to_string(b) == "(5 m,5 m,1 m;20\u00B0,30\u00B0)"));
		coordinates_3dr<> c;
		point_3d<> c2(100_m,1_m,2_m);
		c = c2;
		CHECK (bool(to_string(c) == "(100 m,1 m,2 m;0\u00B0,0\u00B0)"));
		...
		d = d2;
		CHECK (bool(to_string(d) == "(100 m,1 m,2 m;0\u00B0,0\u00B0)"));
		coordinates_3dr<> d3;
		coordinates_3d<> d4(100_m,1_m,2_m);
		d3 = std::move(d4);
		CHECK (bool(to_string(d3) == "(100 m,1 m,2 m;0\u00B0,0\u00B0)"));
		coordinates_3dr<> d5;
		d5 = "(1 m,5 m,2 m;0\u00B0,0\u00B0)";
		CHECK (bool(to_string(d5) == "(1 m,5 m,2 m;0\u00B0,0\u00B0)"));
		coordinates_3dr<> e;
		e = "1 m,5 m,2 m;0\u00B0,0\u00B0";
		CHECK (bool(to_string(e) == "(1 m,5 m,2 m;0\u00B0,0\u00B0)"));
		coordinates_3dr<> f;
	...
	SECTION("Assignments of coordinates_3dr<float> class")
	{
		...
		d = d2;
		CHECK (bool(to_string(d) == "(100,1,2;0\u00B0,0\u00B0)"));
		coordinates_3dr<float> d3;
		coordinates_3d<float> d4(100.0f,1.0f,2.0f);
		d3 = std::move(d4);
		CHECK (bool(to_string(d3) == "(100,1,2;0\u00B0,0\u00B0)"));
		coordinates_3dr<float> d5;
		d5 = "(1,5,2;0\u00B0,0\u00B0)";
		CHECK (bool(to_string(d5) == "(1,5,2;0\u00B0,0\u00B0)"));
	...
	SECTION("Values of different coordinates systems of coordinates_3dr<> class")
	{
		...
		CHECK (bool(c.get_p().display() == "8.06 m"));
		CHECK (bool(c.get_spherical_theta().display() == "29.74\u00B0"));
		CHECK (bool(c.get_r().display() == "8.3 m"));
	...
	SECTION("set_position(), rotate() and move() of coordinates_3dr<> class")
	{
		...
		CHECK (bool(to_string(a) == "(5 m,5 m,1 m;0\u00B0,0\u00B0)"));
		a.set_position(5_m,angle(30.0f),1_m);
		CHECK (bool(to_string(a) == "(4.33 m,2.5 m,1 m;0\u00B0,0\u00B0)"));
		a.set_position(5_m,angle(30.0f),angle(45.0f));
		CHECK (bool(to_string(a) == "(3.06 m,1.76 m,3.53 m;0\u00B0,0\u00B0)"));
	...
	SECTION("Display of coordinates_3dr<float> class")
	{
		...
		CHECK (bool(a.display_cartesian() == "(2,3,5;20\u00B0,30\u00B0)"));
		CHECK (bool(a.display_cylindrical() == "(3.6,56.3\u00B0,5;20\u00B0,30\u00B0)"));
		CHECK (bool(a.display_spherical() == "(6.16,56.3\u00B0,35.79\u00B0;20\u00B0,30\u00B0)"));
		/*coordinates_3dr<> b(2_m,3_m,10000_km);
		cout << "b display geographical: " << b.display_geographical() << endl;
		CHECK (bool(b.display_geographical() == ""));*/
	}
	...
	{
		coordinates_3dr<> a(2_m,3_m,5_m,angle(20.0f),angle(30.0f));
		CHECK (bool(to_string(a) == "(2 m,3 m,5 m;20\u00B0,30\u00B0)"));
	}

	SECTION("to_string() of coordinates_3dr<float> class")
	{
		coordinates_3dr<float> a(2.0f,3.0f,5.0f,angle(20.0f),angle(30.0f));
		CHECK (bool(to_string(a) == "(2,3,5;20\u00B0,30\u00B0)"));
	}
	...
	SECTION("String operators of coordinates_3dr<> class")
	{
		...
		string b = "x: ";
		b += a;
		CHECK(bool(b == "x: (7 m,4 m,2 m;20\u00B0,30\u00B0)"));
		CHECK(bool(("x: " + a) == "x: (7 m,4 m,2 m;20\u00B0,30\u00B0)"));
		CHECK(bool("x: (7 m,4 m,2 m;20\u00B0,30\u00B0)" == ("x: " + a)));
	}
	...
	SECTION("String operators of coordinates_3dr<float> class")
	{
		...
		string b = "x: ";
		b += a;
		CHECK(bool(b == "x: (7,4,2;20\u00B0,30\u00B0)"));
		CHECK(bool(("x: " + a) == "x: (7,4,2;20\u00B0,30\u00B0)"));
		CHECK(bool("x: (7,4,2;20\u00B0,30\u00B0)" == ("x: " + a)));
	}
	...
	SECTION("Stream operators of coordinates_3dr<> class")
	{
		...
		ostringstream out;
		out << a;
		CHECK(bool(out.str() == "(2 m,3 m,2 m;20\u00B0,30\u00B0)"));
		istringstream iss("(1 m,2 m,1 m;30\u00B0,40\u00B0)");
		coordinates_3dr<> b;
		iss >> b;
		CHECK(bool(to_string(b) == "(1 m,2 m,1 m;30\u00B0,40\u00B0)"));
	}
	...
	SECTION("Stream operators of coordinates_3dr<float> class")
	{
		...
		ostringstream out;
		out << a;
		CHECK(bool(out.str() == "(2,3,2;20\u00B0,30\u00B0)"));
		istringstream iss("(1,2,1;30\u00B0,40\u00B0)");
		coordinates_3dr<float> b;
		iss >> b;
		CHECK(bool(to_string(b) == "(1,2,1;30\u00B0,40\u00B0)"));
	}
}
