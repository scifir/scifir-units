...
TEST_CASE("class coordinates_2dr<T> and coordinates_2dr<float>")
{
	...
	SECTION("move(), set_position() and distance_to_origin() of coordinates_2dr<> class")
	{
		...
		CHECK (bool(to_string(a) == "(20 m,7 m;40\u00B0)"));
		a.set_position(10_m,angle(45.0f));
		CHECK (bool(to_string(a) == "(7.07 m,7.07 m;40\u00B0)"));
		coordinates_2dr<> b(10_m,4_m,angle(40.0f));
		b.move(35_m,10_m);
		CHECK (bool(to_string(b) == "(45 m,14 m;40\u00B0)"));
		b.move(10_m,angle(30.0f));
		CHECK (bool(to_string(b) == "(53.66 m,19 m;40\u00B0)"));
		displacement_2d x(20_m,angle(40.0f));
		b.move(x);
		CHECK (bool(to_string(b) == "(68.98 m,31.85 m;40\u00B0)"));
		...
		CHECK (bool(to_string(e) == "(5.17 m,19.31 m;40\u00B0)"));
		e.rotate(angle(15.0f));
		CHECK (bool(to_string(e) == "(0 m,20 m;40\u00B0)"));
	}
	...
	SECTION("move(), set_position() and distance_to_origin() of coordinates_2dr<float> class")
	{
		...
		a.set_position(20,7);
		CHECK (bool(to_string(a) == "(20,7;40\u00B0)"));
		a.set_position(10,angle(45.0f));
		CHECK (bool(to_string(a) == "(7.07,7.07;40\u00B0)"));
		coordinates_2dr<float> b(10,4,angle(40.0f));
		b.move(35,10);
		CHECK (bool(to_string(b) == "(45,14;40\u00B0)"));
		b.move(10,angle(30.0f));
		CHECK (bool(to_string(b) == "(53.66,19;40\u00B0)"));
		displacement_2d x(20_m,angle(40.0f));
		b.move(x);
		CHECK (bool(to_string(b) == "(68.98,31.85;40\u00B0)"));
	...
	SECTION("distance() functions of coordinates_2dr<> class")
	{
		...
		CHECK (bool(to_string(distance(e,f)) == "15.81 m"));
		CHECK (bool(to_string(distance(f,e)) == "15.81 m"));
	}
	...
	SECTION("distance() functions of coordinates_2dr<float> class")
	{
		...
		CHECK (bool(display_float(distance(e,f),2) == "15.81"));
		CHECK (bool(display_float(distance(f,e),2) == "15.81"));
	}
	...
	SECTION("String operators of coordinates_2dr<> class")
	{
		...
		string b = "x: ";
		b += a;
		CHECK(bool(b == "x: (7 m,4 m;40\u00B0)"));
		CHECK(bool(("x: " + a) == "x: (7 m,4 m;40\u00B0)"));
		CHECK(bool("x: (7 m,4 m;40\u00B0)" == ("x: " + a)));
	}
	...
	SECTION("String operators of coordinates_2dr<float> class")
	{
		...
		string b = "x: ";
		b += a;
		CHECK(bool(b == "x: (7,4;40\u00B0)"));
		CHECK(bool(("x: " + a) == "x: (7,4;40\u00B0)"));
		CHECK(bool("x: (7,4;40\u00B0)" == ("x: " + a)));
	}
	...
	SECTION("Display of coordinates_2dr<> class")
	{
		...
		ostringstream out;
		out << a;
		CHECK(bool(out.str() == "(2 m,3 m;40\u00B0)"));
		istringstream iss("(1 m,2 m;40\u00B0)");
		coordinates_2dr b;
		iss >> b;
		CHECK(bool(to_string(b) == "(1 m,2 m;40\u00B0)"));
	}
	...
	SECTION("Display of coordinates_2dr<float> class")
	{
		...
		ostringstream out;
		out << a;
		CHECK(bool(out.str() == "(2,3;40\u00B0)"));
		istringstream iss("(1,2;40\u00B0)");
		coordinates_2dr<float> b;
		iss >> b;
		CHECK(bool(to_string(b) == "(1,2;40\u00B0)"));
	}
}
