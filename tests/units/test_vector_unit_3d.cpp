...
TEST_CASE("class vector_unit_3d")
{
	SECTION("Constructors of vector_unit_3d class")
	{
		...
		vector_unit_3d p(30.0f, dimension::DIMENSION_PASCAL, prefix::KILO, 20.0f, 30.0f);
		CHECK(to_string(p) == "30 kPa 20θ 30Φ");
		vector_unit_3d p2(30.0, dimension::DIMENSION_PASCAL, prefix::KILO, 20.0f, 30.0f);
		CHECK(to_string(p2) == "30 kPa 20θ 30Φ");
		vector_unit_3d p3(30.0l, dimension::DIMENSION_PASCAL, prefix::KILO, 20.0f, 30.0f);
		CHECK(to_string(p3) == "30 kPa 20θ 30Φ");
		vector_unit_3d p4(30, dimension::DIMENSION_PASCAL, prefix::KILO, 20.0f, 30.0f);
		CHECK(to_string(p4) == "30 kPa 20θ 30Φ");
		vector_unit_3d p5(30.0f, dimension::DIMENSION_PASCAL, prefix::KILO, angle(20.0f), angle(30.0f));
		CHECK(to_string(p5) == "30 kPa 20θ 30Φ");
		vector_unit_3d p6(30.0, dimension::DIMENSION_PASCAL, prefix::KILO, angle(20.0f), angle(30.0f));
		CHECK(to_string(p6) == "30 kPa 20θ 30Φ");
		vector_unit_3d p7(30.0l, dimension::DIMENSION_PASCAL, prefix::KILO, angle(20.0f), angle(30.0f));
		CHECK(to_string(p7) == "30 kPa 20θ 30Φ");
		vector_unit_3d p8(30, dimension::DIMENSION_PASCAL, prefix::KILO, angle(20.0f), angle(30.0f));
