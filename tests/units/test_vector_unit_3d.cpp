...
TEST_CASE("class vector_unit_3d")
{
	...
	SECTION("point_to() function of vector_unit_3d classes")
	{
		...
		CHECK (bool(a.theta.get_value() == 270.0f));
		CHECK (bool(a.phi.get_value() == 90.0f));
		a.point_to(direction::RIGHT);
		CHECK (bool(a.theta.get_value() == 90.0f));
		CHECK (bool(a.phi.get_value() == 90.0f));
		a.point_to(direction::TOP);
		CHECK (bool(a.theta.get_value() == 0.0f));
		CHECK (bool(a.phi.get_value() == 0.0f));
		a.point_to(direction::BOTTOM);
		CHECK (bool(a.theta.get_value() == 0.0f));
		CHECK (bool(a.phi.get_value() == 180.0f));
		a.point_to(direction::LEFT_TOP);
		CHECK (bool(a.theta.get_value() == 270.0f));
		CHECK (bool(a.phi.get_value() == 45.0f));
		a.point_to(direction::RIGHT_TOP);
		CHECK (bool(a.theta.get_value() == 90.0f));
		CHECK (bool(a.phi.get_value() == 45.0f));
		a.point_to(direction::RIGHT_BOTTOM);
		CHECK (bool(a.theta.get_value() == 90.0f));
		CHECK (bool(a.phi.get_value() == 135.0f));
		...
		CHECK (bool(a.theta.get_value() == 180.0f));
		CHECK (bool(a.phi.get_value() == 90.0f));
		a.point_to(direction::LEFT_FRONT);
		CHECK (bool(a.theta.get_value() == 315.0f));
		CHECK (bool(a.phi.get_value() == 90.0f));
		a.point_to(direction::RIGHT_FRONT);
		CHECK (bool(a.theta.get_value() == 45.0f));
		CHECK (bool(a.phi.get_value() == 90.0f));
		...
		CHECK (bool(a.theta.get_value() == 225.0f));
		CHECK (bool(a.phi.get_value() == 90.0f));
		a.point_to(direction::RIGHT_BACK);
		CHECK (bool(a.theta.get_value() == 135.0f));
		CHECK (bool(a.phi.get_value() == 90.0f));
	...
	SECTION("Operators of vector_unit_3d classes with scalar_unit classes")
	{
		...
		scalar_unit a2("5 g");
		CHECK (bool(to_string(a * a2) == "50 g*kg*m/s2 10\u03B8 10\u03A6"));
		vector_unit_3d a3 = (a * a2);
		a3.change_dimensions("N*g");
		CHECK (bool(to_string(a3) == "50 N*g 10\u03B8 10\u03A6"));
		CHECK (bool(to_string(a2 * a) == "50 g*kg*m/s2 10\u03B8 10\u03A6"));
		vector_unit_3d b("10 N",10.0f,10.0f);
		scalar_unit b2("5 g");
		CHECK (bool(to_string(b / b2) == "2000 m/s2 10\u03B8 10\u03A6"));
		vector_unit_3d c("10 N",10.0f,10.0f);
		scalar_unit c2(10_N / 5_N);
		CHECK (bool(to_string(c ^ c2) == "100 N2 10\u03B8 10\u03A6"));
	...
	SECTION("Numeric operators of vector_unit_3d classes")
	{
		...
		CHECK (bool(to_string(a + 10.0f) == "20 N 20\u03B8 20\u03A6"));
		CHECK (bool(to_string(10.0f + a) == "20 N 20\u03B8 20\u03A6"));
		vector_unit_3d b("10 N",20.0f,20.0f);
		CHECK (bool(to_string(b - 5.0f) == "5 N 20\u03B8 20\u03A6"));
		CHECK (bool(to_string(20.0f - b) == "10 N 20\u03B8 20\u03A6"));
		vector_unit_3d c("10 N",20.0f,20.0f);
		CHECK (bool(to_string(c * 2.0f) == "20 N 20\u03B8 20\u03A6"));
		CHECK (bool(to_string(2.0f * c) == "20 N 20\u03B8 20\u03A6"));
		vector_unit_3d d("10 N",20.0f,20.0f);
		CHECK (bool(to_string(d / 2.0f) == "5 N 20\u03B8 20\u03A6"));
		CHECK (bool(to_string(20.0f / d) == "2 1/N 20\u03B8 20\u03A6"));
		vector_unit_3d e("10 N",20.0f,20.0f);
		CHECK (bool(to_string(e ^ 2) == "100 N2 20\u03B8 20\u03A6"));
		vector_unit_3d f("10 N",20.0f,20.0f);
		f += 5.0f;
		CHECK (bool(to_string(f) == "15 N 20\u03B8 20\u03A6"));
		vector_unit_3d g("10 N",20.0f,20.0f);
		g -= 5.0f;
		CHECK (bool(to_string(g) == "5 N 20\u03B8 20\u03A6"));
		vector_unit_3d h("10 N",20.0f,20.0f);
		h *= 2.0f;
		CHECK (bool(to_string(h) == "20 N 20\u03B8 20\u03A6"));
		vector_unit_3d i("10 N",20.0f,20.0f);
		i *= -2.0f;
		CHECK (bool(to_string(i) == "20 N 200\u03B8 160\u03A6"));
		vector_unit_3d j("10 N",20.0f,20.0f);
		j /= 2.0f;
		CHECK (bool(to_string(j) == "5 N 20\u03B8 20\u03A6"));
		vector_unit_3d k("10 N",20.0f,20.0f);
		k /= -2.0f;
		CHECK (bool(to_string(k) == "5 N 200\u03B8 160\u03A6"));
	}
	...
	SECTION("Invertion of vector_unit_3d classes")
	{
		vector_unit_3d a("2 N",10.0f,10.0f);
		a.invert();
		CHECK (bool(to_string(a) == "2 N 190\u03B8 170\u03A6"));
	}

	SECTION("Display of vector_unit_3d classes")
	{
		vector_unit_3d a = vector_unit_3d(1,"N",20,20);
		CHECK (bool(a.vectorial_display() == "1 N 20\u03B8 20\u03A6"));
		CHECK (bool(a.vectorial_derived_display() == "1 kg*m/s2 20\u03B8 20\u03A6"));
		CHECK (bool(a.vectorial_custom_display("g*m/s2") == "1000 g*m/s2 20\u03B8 20\u03A6"));
	}
	...
	SECTION("String operations with vector_unit_3d classes")
	{
		...
		string b2 = "b: ";
		b2 += b;
		CHECK (bool("b: 2 N 10\u03B8 10\u03A6"));
		vector_unit_3d c("2 N",10.0f,10.0f);
		CHECK (bool(("b: " + c) == "b: 2 N 10\u03B8 10\u03A6"));
		CHECK (bool((c + " b") == "2 N 10\u03B8 10\u03A6 b"));
	}
