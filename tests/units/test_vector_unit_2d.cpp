...
TEST_CASE("class vector_unit_2d")
{
	...
	SECTION("Operations of vector_unit_2d classes with other vector_unit_2d classes")
	{
		...
		CHECK(bool(to_string(e + vector_unit_2d(100.0f,"m",20)) == "200 m 20\u03B8"));
		CHECK(bool(to_string(e + vector_unit_2d(100.0f,"g",20)) == "0 [empty] 0\u03B8"));
		vector_unit_2d f = vector_unit_2d(100.0f,"m",20);
		cout << "f -: " << to_string(f - vector_unit_2d(20.0f,"m",20)) << endl;
		CHECK(bool(to_string(f - vector_unit_2d(20.0f,"m",20)) == "80 m 20\u03B8"));
		CHECK(bool(to_string(f - vector_unit_2d(100.0f,"g",20)) == "0 [empty] 0\u03B8"));
	}
	...
	SECTION("Operations of vector_unit_2d classes with scalar_unit classes")
	{
		...
		CHECK(bool(to_string(a ^ b) == "0 [empty] 0\u03B8"));
		CHECK(bool(to_string(a ^ b2) == "10000 m2 10\u03B8"));
		vector_unit_2d c = vector_unit_2d(100.0f,"m",10);
		scalar_unit d = scalar_unit("2 m");
		CHECK(bool(to_string(d * c) == "200 m2 10\u03B8"));
		CHECK(bool(to_string(c * d) == "200 m2 10\u03B8"));
		vector_unit_2d e = vector_unit_2d(100.0f,"m2",10);
		scalar_unit f = scalar_unit("2 m");
		CHECK(bool(to_string(e / f) == "50 m 10\u03B8"));
	}

	SECTION("Operations of vector_unit_2d classes with numbers")
	{
		vector_unit_2d f = vector_unit_2d(100.0f,"m",10);
		CHECK(bool(to_string(f + 50) == "150 m 10\u03B8"));
		CHECK(bool(to_string(f - 50) == "50 m 10\u03B8"));
		CHECK(bool(to_string(f * 2) == "200 m 10\u03B8"));
		CHECK(bool(to_string(f / 4) == "25 m 10\u03B8"));
		CHECK(bool(to_string(f ^ 2) == "10000 m2 10\u03B8"));
		CHECK(bool(to_string(50 + f) == "150 m 10\u03B8"));
		CHECK(bool(to_string(150 - f) == "50 m 10\u03B8"));
		CHECK(bool(to_string(2 * f) == "200 m 10\u03B8"));
		CHECK(bool(to_string(200 / f) == "2 1/m 10\u03B8"));
		vector_unit_2d g = vector_unit_2d(100.0f,"m",10);
		g += 10;
		CHECK(bool(to_string(g) == "110 m 10\u03B8"));
		vector_unit_2d h = vector_unit_2d(100.0f,"m",10);
		h -= 10;
		CHECK(bool(to_string(h) == "90 m 10\u03B8"));
		vector_unit_2d i = vector_unit_2d(100.0f,"m",10);
		i *= 2;
		CHECK(bool(to_string(i) == "200 m 10\u03B8"));
		vector_unit_2d i2 = vector_unit_2d(100.0f,"m",10);
		i2 *= -2;
		CHECK(bool(to_string(i2) == "200 m 190\u03B8"));
		vector_unit_2d j = vector_unit_2d(100.0f,"m",10);
		j /= 2;
		CHECK(bool(to_string(j) == "50 m 10\u03B8"));
		vector_unit_2d j2 = vector_unit_2d(100.0f,"m",10);
		j2 /= -2;
		CHECK(bool(to_string(j2) == "50 m 190\u03B8"));
		CHECK(bool(to_string(i.x_projection()) == "196.96 m"));
		CHECK(bool(to_string(i.y_projection()) == "34.72 m"));
		vector_unit_2d k = vector_unit_2d(100.0f,"m",10);
		k.invert();
		CHECK(bool(to_string(k) == "100 m 190\u03B8"));
	}

	SECTION("Projections of vector_unit_2d classes")
	{
		vector_unit_2d a("2 N",10.0f);
		CHECK (bool(a.x_projection().display(2) == "1.96 N"));
		CHECK (bool(a.y_projection().display(2) == "0.34 N"));
	}
	...
	SECTION("Invertion of vector_unit_2d classes")
	{
		vector_unit_2d a("2 N",10.0f);
		a.invert();
		CHECK (bool(to_string(a) == "2 N 190\u03B8"));
	}

	SECTION("Display of vector_unit_2d classes")
	{
		vector_unit_2d a = vector_unit_2d(1.0f,"N",20);
		CHECK (bool(a.vectorial_display() == "1 N 20\u03B8"));
		CHECK (bool(a.vectorial_derived_display() == "1 kg*m/s2 20\u03B8"));
		CHECK (bool(a.vectorial_custom_display("g*m/s2") == "1000 g*m/s2 20\u03B8"));
	}
	...
	SECTION("String operations with vector_unit_2d classes")
	{
		...
		string b2 = "b: ";
		b2 += b;
		CHECK (bool("b: 2 N 10\u03B8"));
		vector_unit_2d c("2 N",10.0f);
		CHECK (bool(("b: " + c) == "b: 2 N 10\u03B8"));
		CHECK (bool((c + " b") == "2 N 10\u03B8 b"));
	}
