...
TEST_CASE("class vector_unit_nd")
{
	SECTION("Constructors of vector_unit_nd classes")
	{
		...
		vector_unit_nd r(50.0f,{dimension("m",dimension::POSITIVE)});
		CHECK(to_string(r) == "50 m");
		vector_unit_nd r2(50.0,{dimension("m",dimension::POSITIVE)});
		CHECK(to_string(r2) == "50 m");
		vector_unit_nd r3(50.0l,{dimension("m",dimension::POSITIVE)});
		CHECK(to_string(r3) == "50 m");
		vector_unit_nd r4(50,{dimension("m",dimension::POSITIVE)});
		CHECK(to_string(r4) == "50 m");
		vector_unit_nd f(50.0f,{dimension("m",dimension::POSITIVE)},{20,20,20});
		CHECK(to_string(f) == "50 m 20° 20° 20°");
		vector_unit_nd g(50.0f,{dimension("m",dimension::POSITIVE)},{angle(20.0f),angle(20.0f)});
		CHECK(to_string(g) == "50 m 20° 20°");
		vector_unit_nd f2(50.0,{dimension("m",dimension::POSITIVE)},{20,20,20});
		CHECK(to_string(f2) == "50 m 20° 20° 20°");
		vector_unit_nd g2(50.0,{dimension("m",dimension::POSITIVE)},{angle(20.0f),angle(20.0f)});
		CHECK(to_string(g2) == "50 m 20° 20°");
		vector_unit_nd f3(50.0l,{dimension("m",dimension::POSITIVE)},{20,20,20});
		CHECK(to_string(f3) == "50 m 20° 20° 20°");
		vector_unit_nd g3(50.0l,{dimension("m",dimension::POSITIVE)},{angle(20.0f),angle(20.0f)});
		CHECK(to_string(g3) == "50 m 20° 20°");
		vector_unit_nd f4(50,{dimension("m",dimension::POSITIVE)},{20,20,20});
		CHECK(to_string(f4) == "50 m 20° 20° 20°");
		vector_unit_nd g4(50,{dimension("m",dimension::POSITIVE)},{angle(20.0f),angle(20.0f)});
