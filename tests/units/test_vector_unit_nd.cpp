...
TEST_CASE("class vector_unit_nd")
{
	SECTION("Constructors of vector_unit_nd class")
	{
		...
		vector_unit_nd s(30.0f, dimension::DIMENSION_PASCAL, prefix::KILO, { 20.0f, 30.0f });
		CHECK(to_string(s) == "30 kPa 20° 30°");
		vector_unit_nd s2(30.0, dimension::DIMENSION_PASCAL, prefix::KILO, { 20.0f, 30.0f });
		CHECK(to_string(s2) == "30 kPa 20° 30°");
		vector_unit_nd s3(30.0l, dimension::DIMENSION_PASCAL, prefix::KILO, { 20.0f, 30.0f });
		CHECK(to_string(s3) == "30 kPa 20° 30°");
		vector_unit_nd s4(30, dimension::DIMENSION_PASCAL, prefix::KILO, { 20.0f, 30.0f });
		CHECK(to_string(s4) == "30 kPa 20° 30°");
		vector_unit_nd s5(30.0f, dimension::DIMENSION_PASCAL, prefix::KILO, { angle(20.0f), angle(30.0f) });
		CHECK(to_string(s5) == "30 kPa 20° 30°");
		vector_unit_nd s6(30.0, dimension::DIMENSION_PASCAL, prefix::KILO, { angle(20.0f), angle(30.0f) });
		CHECK(to_string(s6) == "30 kPa 20° 30°");
		vector_unit_nd s7(30.0l, dimension::DIMENSION_PASCAL, prefix::KILO, { angle(20.0f), angle(30.0f) });
		CHECK(to_string(s7) == "30 kPa 20° 30°");
		vector_unit_nd s8(30, dimension::DIMENSION_PASCAL, prefix::KILO, { angle(20.0f), angle(30.0f) });
