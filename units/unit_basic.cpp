...
namespace scifir
{
	...
	string time_duration::display_as_time() const
	{
		...
		if (*this >= one_year)
		{
			...
			remaining_time -= scifir::time_duration(total_of_years * 365,"d");
		}
		scifir::time_duration one_month("30d");
		if (remaining_time >= one_month)
		{
			...
			remaining_time -= scifir::time_duration(total_of_months * 30,"d");
		}
		scifir::time_duration one_day("1d");
		if (remaining_time >= one_day)
		{
			...
			remaining_time -= scifir::time_duration(total_of_days,"d");
		}
		scifir::time_duration one_hour("1h");
		if (remaining_time >= one_hour)
		{
			...
			remaining_time -= scifir::time_duration(total_of_hours,"h");
		}
		...
		if (remaining_time >= one_minute)
		{
			...
			remaining_time -= scifir::time_duration(total_of_minutes,"min");
		}
		scifir::time_duration one_second("1s");
