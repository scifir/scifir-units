...
namespace scifir
{
	class vector_unit_nd : public scalar_unit
	{
		public:
			...
			explicit vector_unit_nd(double,const string&);
			explicit vector_unit_nd(double,const string&,const vector<float>&);
			explicit vector_unit_nd(double,const string&,const vector<angle>&);
			explicit vector_unit_nd(long double,const string&);
			explicit vector_unit_nd(long double,const string&,const vector<float>&);
			explicit vector_unit_nd(long double,const string&,const vector<angle>&);
			explicit vector_unit_nd(int,const string&);
			explicit vector_unit_nd(int,const string&,const vector<float>&);
			explicit vector_unit_nd(int,const string&,const vector<angle>&);
			...
			explicit vector_unit_nd(double,const vector<dimension>&);
			explicit vector_unit_nd(double,const vector<dimension>&,const vector<float>&);
			explicit vector_unit_nd(double,const vector<dimension>&,const vector<angle>&);
			explicit vector_unit_nd(long double,const vector<dimension>&);
			explicit vector_unit_nd(long double,const vector<dimension>&,const vector<float>&);
			explicit vector_unit_nd(long double,const vector<dimension>&,const vector<angle>&);
			explicit vector_unit_nd(int,const vector<dimension>&);
			explicit vector_unit_nd(int,const vector<dimension>&,const vector<float>&);
			explicit vector_unit_nd(int,const vector<dimension>&,const vector<angle>&);
