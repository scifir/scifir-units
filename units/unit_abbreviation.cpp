...
length operator"" _Ym(unsigned long long int x)
{
	return length(float(x), "Ym");
}

length operator"" _Zm(unsigned long long int x)
{
	return length(float(x), "Zm");
}

length operator"" _Em(unsigned long long int x)
{
	return length(float(x), "Em");
}

length operator"" _Pm(unsigned long long int x)
{
	return length(float(x), "Pm");
}

length operator"" _Tm(unsigned long long int x)
{
	return length(float(x), "Tm");
}

length operator"" _Gm(unsigned long long int x)
{
	return length(float(x), "Gm");
}

length operator"" _Mm(unsigned long long int x)
{
	return length(float(x), "Mm");
}

length operator"" _km(unsigned long long int x)
{
	return length(float(x), "km");
}

length operator"" _hm(unsigned long long int x)
{
	return length(float(x), "hm");
}

length operator"" _dam(unsigned long long int x)
{
	return length(float(x), "dam");
}

length operator"" _m(unsigned long long int x)
{
	return length(float(x), "m");
}

length operator"" _dm(unsigned long long int x)
{
	return length(float(x), "dm");
}

length operator"" _cm(unsigned long long int x)
{
	return length(float(x), "cm");
}
...
length operator"" _um(unsigned long long int x)
{
	return length(float(x), "um");
}

length operator"" _nm(unsigned long long int x)
{
	return length(float(x), "nm");
}
...
length operator"" _fm(unsigned long long int x)
{
	return length(float(x), "fm");
}

length operator"" _am(unsigned long long int x)
{
	return length(float(x), "am");
}
...
{
	return frequency(float(x), "uHz");
}

frequency operator"" _nHz(unsigned long long int x)
{
	return frequency(float(x), "nHz");
}
...
{
	return frequency(float(x), "fHz");
}

frequency operator"" _aHz(unsigned long long int x)
{
	return frequency(float(x), "aHz");
}
...
{
	return force(float(x), "uN");
}

force operator"" _nN(unsigned long long int x)
{
	return force(float(x), "nN");
}
...
{
	return force(float(x), "fN");
}

force operator"" _aN(unsigned long long int x)
{
	return force(float(x), "aN");
}
...
{
	return pressure(float(x), "uPa");
}

pressure operator"" _nPa(unsigned long long int x)
{
	return pressure(float(x), "nPa");
}
...
{
	return pressure(float(x), "fPa");
}

pressure operator"" _aPa(unsigned long long int x)
{
	return pressure(float(x), "aPa");
}
...
{
	return energy(float(x), "uJ");
}

energy operator"" _nJ(unsigned long long int x)
{
	return energy(float(x), "nJ");
}
...
{
	return energy(float(x), "fJ");
}

energy operator"" _aJ(unsigned long long int x)
{
	return energy(float(x), "aJ");
}
...
{
	return power(float(x), "uW");
}

power operator"" _nW(unsigned long long int x)
{
	return power(float(x), "nW");
}
...
{
	return power(float(x), "fW");
}

power operator"" _aW(unsigned long long int x)
{
	return power(float(x), "aW");
}
...
{
	return electric_current(float(x), "uA");
}

electric_current operator"" _nA(unsigned long long int x)
{
	return electric_current(float(x), "nA");
}
...
{
	return electric_current(float(x), "fA");
}

electric_current operator"" _aA(unsigned long long int x)
{
	return electric_current(float(x), "aA");
}
...
{
	return voltage(float(x), "uV");
}

voltage operator"" _nV(unsigned long long int x)
{
	return voltage(float(x), "nV");
}
...
{
	return voltage(float(x), "fV");
}

voltage operator"" _aV(unsigned long long int x)
{
	return voltage(float(x), "aV");
}
...
{
	return capacitance(float(x), "uF");
}

capacitance operator"" _nF(unsigned long long int x)
{
	return capacitance(float(x), "nF");
}
...
{
	return capacitance(float(x), "fF");
}

capacitance operator"" _aF(unsigned long long int x)
{
	return capacitance(float(x), "aF");
}
...
{
	return electric_conductance(float(x), "uS");
}

electric_conductance operator"" _nS(unsigned long long int x)
{
	return electric_conductance(float(x), "nS");
}
...
{
	return electric_conductance(float(x), "fS");
}

electric_conductance operator"" _aS(unsigned long long int x)
{
	return electric_conductance(float(x), "aS");
}
...
{
	return magnetic_flux(float(x), "uWb");
}

magnetic_flux operator"" _nWb(unsigned long long int x)
{
	return magnetic_flux(float(x), "nWb");
}
...
{
	return magnetic_flux(float(x), "fWb");
}

magnetic_flux operator"" _aWb(unsigned long long int x)
{
	return magnetic_flux(float(x), "aWb");
}
...
{
	return magnetic_strength(float(x), "uT");
}

magnetic_strength operator"" _nT(unsigned long long int x)
{
	return magnetic_strength(float(x), "nT");
}
...
{
	return magnetic_strength(float(x), "fT");
}

magnetic_strength operator"" _aT(unsigned long long int x)
{
	return magnetic_strength(float(x), "aT");
}
...
{
	return inductance(float(x), "uH");
}

inductance operator"" _nH(unsigned long long int x)
{
	return inductance(float(x), "nH");
}
...
{
	return inductance(float(x), "fH");
}

inductance operator"" _aH(unsigned long long int x)
{
	return inductance(float(x), "aH");
}
...
{
	return luminous_flux(float(x), "ulm");
}

luminous_flux operator"" _nlm(unsigned long long int x)
{
	return luminous_flux(float(x), "nlm");
}
...
{
	return luminous_flux(float(x), "flm");
}

luminous_flux operator"" _alm(unsigned long long int x)
{
	return luminous_flux(float(x), "alm");
}
...
{
	return illuminance(float(x), "ulx");
}

illuminance operator"" _nlx(unsigned long long int x)
{
	return illuminance(float(x), "nlx");
}
...
{
	return illuminance(float(x), "flx");
}

illuminance operator"" _alx(unsigned long long int x)
{
	return illuminance(float(x), "alx");
}
...
{
	return radioactivity(float(x), "uBq");
}

radioactivity operator"" _nBq(unsigned long long int x)
{
	return radioactivity(float(x), "nBq");
}
...
{
	return radioactivity(float(x), "fBq");
}

radioactivity operator"" _aBq(unsigned long long int x)
{
	return radioactivity(float(x), "aBq");
}
...
{
	return ionizing_radiation(float(x), "uGy");
}

ionizing_radiation operator"" _nGy(unsigned long long int x)
{
	return ionizing_radiation(float(x), "nGy");
}
...
{
	return ionizing_radiation(float(x), "fGy");
}

ionizing_radiation operator"" _aGy(unsigned long long int x)
{
	return ionizing_radiation(float(x), "aGy");
}
...
{
	return ionizing_radiation(float(x), "uSv");
}

ionizing_radiation operator"" _nSv(unsigned long long int x)
{
	return ionizing_radiation(float(x), "nSv");
}
...
{
	return ionizing_radiation(float(x), "fSv");
}

ionizing_radiation operator"" _aSv(unsigned long long int x)
{
	return ionizing_radiation(float(x), "aSv");
}
...
{
	return catalytic_activity(float(x), "ukat");
}

catalytic_activity operator"" _nkat(unsigned long long int x)
{
	return catalytic_activity(float(x), "nkat");
}
...
{
	return catalytic_activity(float(x), "fkat");
}

catalytic_activity operator"" _akat(unsigned long long int x)
{
	return catalytic_activity(float(x), "akat");
}
...
{
	return length(float(x), "angstrom");
}

volume operator"" _L(unsigned long long int x)
{
	return volume(float(x), "");
}
...
{
	return length(float(x), "uAU");
}

length operator"" _nAU(unsigned long long int x)
{
	return length(float(x), "nAU");
}
...
{
	return length(float(x), "fAU");
}

length operator"" _aAU(unsigned long long int x)
{
	return length(float(x), "aAU");
}
...
{
	return length(float(x), "upc");
}

length operator"" _npc(unsigned long long int x)
{
	return length(float(x), "npc");
}
...
{
	return length(float(x), "fpc");
}

length operator"" _apc(unsigned long long int x)
{
	return length(float(x), "apc");
}
...
{
	return energy(float(x), "ueV");
}

energy operator"" _neV(unsigned long long int x)
{
	return energy(float(x), "neV");
}
...
{
	return energy(float(x), "feV");
}

energy operator"" _aeV(unsigned long long int x)
{
	return energy(float(x), "aeV");
}
...
{
	return area(float(x), "ub");
}

area operator"" _nb(unsigned long long int x)
{
	return area(float(x), "nb");
}
...
{
	return area(float(x), "fb");
}

area operator"" _ab(unsigned long long int x)
{
	return area(float(x), "ab");
}
...
{
	return molarity(float(x), "uM");
}

molarity operator"" _nM(unsigned long long int x)
{
	return molarity(float(x), "nM");
}
...
{
	return molarity(float(x), "fM");
}

molarity operator"" _aM(unsigned long long int x)
{
	return molarity(float(x), "aM");
}
...
length operator"" _Ym(long double x)
{
	return length(float(x), "Ym");
}

length operator"" _Zm(long double x)
{
	return length(float(x), "Zm");
}

length operator"" _Em(long double x)
{
	return length(float(x), "Em");
}

length operator"" _Pm(long double x)
{
	return length(float(x), "Pm");
}

length operator"" _Tm(long double x)
{
	return length(float(x), "Tm");
}

length operator"" _Gm(long double x)
{
	return length(float(x), "Gm");
}

length operator"" _Mm(long double x)
{
	return length(float(x), "Mm");
}

length operator"" _km(long double x)
{
	return length(float(x), "km");
}

length operator"" _hm(long double x)
{
	return length(float(x), "hm");
}

length operator"" _dam(long double x)
{
	return length(float(x), "dam");
}

length operator"" _m(long double x)
{
	return length(float(x), "m");
}

length operator"" _dm(long double x)
{
	return length(float(x), "dm");
}
...
length operator"" _um(long double x)
{
	return length(float(x), "um");
}

length operator"" _nm(long double x)
{
	return length(float(x), "nm");
}
...
length operator"" _fm(long double x)
{
	return length(float(x), "fm");
}

length operator"" _am(long double x)
{
	return length(float(x), "am");
}
