...
scifir::length operator"" _mm(unsigned long long int);
scifir::length operator"" _µm(unsigned long long int);
...
scifir::time_duration operator"" _µs(unsigned long long int);
...
scifir::mass operator"" _mg(unsigned long long int);
scifir::mass operator"" _µg(unsigned long long int);
...
scifir::charge operator"" _mC(unsigned long long int);
scifir::charge operator"" _µC(unsigned long long int);
...
scifir::temperature operator"" _mK(unsigned long long int);
scifir::temperature operator"" _µK(unsigned long long int);
...
scifir::mole operator"" _mmol(unsigned long long int);
scifir::mole operator"" _µmol(unsigned long long int);
...
scifir::light_intensity operator"" _mcd(unsigned long long int);
scifir::light_intensity operator"" _µcd(unsigned long long int);
...
scifir::length operator"" _mm(long double);
scifir::length operator"" _µm(long double);
...
scifir::time_duration operator"" _µs(long double);
...
scifir::mass operator"" _mg(long double);
scifir::mass operator"" _µg(long double);
...
scifir::charge operator"" _mC(long double);
scifir::charge operator"" _µC(long double);
...
scifir::temperature operator"" _mK(long double);
scifir::temperature operator"" _µK(long double);
...
scifir::mole operator"" _mmol(long double);
scifir::mole operator"" _µmol(long double);
...
scifir::light_intensity operator"" _mcd(long double);
scifir::light_intensity operator"" _µcd(long double);
