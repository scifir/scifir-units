...
bool operator ==(const msci::coordinates_2dr& x,const msci::coordinates_2d& y)
{
...
bool operator ==(const msci::coordinates_2d& x,const msci::coordinates_2dr& y)
{
	if (x.x == y.x and x.y == y.y)
	{
		return true;
...
bool operator ==(const msci::coordinates_2dr& x,const msci::point_2d& y)
{
	if (x.x == y.x and x.y == y.y)
	{
		return true;
...
bool operator ==(const msci::point_2d& x,const msci::coordinates_2dr& y)
{
	if (x.x == y.x and x.y == y.y)
	{
		return true;
